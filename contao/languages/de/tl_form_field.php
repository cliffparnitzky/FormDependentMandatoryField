...
$GLOBALS['TL_LANG']['tl_form_field']['dependentMandatorySuperiorFields'] = array('Übergeordnete Felder', 'Wählen Sie die Formularfelder aus, die, wenn sie den definierten Wert enthalten, das aktuelle Feld zum Pflichtfeld machen. Wenn für ein übergeordnetes Feld mehrere Bedingungen angegeben sind, wird geprüft, ob mindestens eine davon zutrifft (ODER Verknüpfung).');
